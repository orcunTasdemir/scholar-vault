...
export function DocumentGrid({
    ...
    return (
      <div className="flex items-center justify-center py-16">
        <div className="text-center">
          ...
          <p className="text-off-white/60">Loading documents...</p>
        </div>
      </div>
    );
  }
  ...
  if (documents.length === 0) {
    return (
      <div className="text-center py-16 rounded-lg border-2 border-dashed border-off-white/20 bg-deep-charcoal/30">
        <Image
          src="/logo.png"
          alt="No documents"
          width={64}
        ...
        />
        <h3 className="mt-4 text-lg font-semibold text-off-white">
          {selectedCollectionId
